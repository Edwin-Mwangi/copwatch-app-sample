...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setExoplayer(final Application application,String mName,String mImageUrl){
        ...
        try{
            ...
            Log.e("ViewHolder","exoplayer_error"+e.toString());
        }
